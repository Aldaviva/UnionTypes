...
public readonly struct Union<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>: IUnion, IEquatable<Union<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> {
    ...
    /// <summary>The value of the union type if <see cref="HasValue1"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value1"/>; otherwise <c>default</c>.</summary>
    public T1? Value1 { get; }

    /// <summary>The value of the union type if <see cref="HasValue2"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value2"/>; otherwise <c>default</c>.</summary>
    public T2? Value2 { get; }

    /// <summary>The value of the union type if <see cref="HasValue3"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value3"/>; otherwise <c>default</c>.</summary>
    public T3? Value3 { get; }

    /// <summary>The value of the union type if <see cref="HasValue4"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value4"/>; otherwise <c>default</c>.</summary>
    public T4? Value4 { get; }

    /// <summary>The value of the union type if <see cref="HasValue5"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value5"/>; otherwise <c>default</c>.</summary>
    public T5? Value5 { get; }

    /// <summary>The value of the union type if <see cref="HasValue6"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value6"/>; otherwise <c>default</c>.</summary>
    public T6? Value6 { get; }

    /// <summary>The value of the union type if <see cref="HasValue7"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value7"/>; otherwise <c>default</c>.</summary>
    public T7? Value7 { get; }

    /// <summary>The value of the union type if <see cref="HasValue8"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value8"/>; otherwise <c>default</c>.</summary>
    public T8? Value8 { get; }

    /// <summary>The value of the union type if <see cref="HasValue9"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value9"/>; otherwise <c>default</c>.</summary>
    public T9? Value9 { get; }

    /// <summary>The value of the union type if <see cref="HasValue10"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value10"/>; otherwise <c>default</c>.</summary>
    public T10? Value10 { get; }

    /// <summary>The value of the union type if <see cref="HasValue11"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value11"/>; otherwise <c>default</c>.</summary>
    public T11? Value11 { get; }

    /// <summary>The value of the union type if <see cref="HasValue12"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value12"/>; otherwise <c>default</c>.</summary>
    public T12? Value12 { get; }

    /// <summary>The value of the union type if <see cref="HasValue13"/> is <c>true</c>, or equivalently if <see cref="ValueIndex"/> is <see cref="Union13Index.Value13"/>; otherwise <c>default</c>.</summary>
    ...
    public Type ValueType => ValueIndex switch {
        Union13Index.Value1 => typeof(T1),
        Union13Index.Value2 => typeof(T2),
        Union13Index.Value3 => typeof(T3),
        Union13Index.Value4 => typeof(T4),
        Union13Index.Value5 => typeof(T5),
        Union13Index.Value6 => typeof(T6),
        Union13Index.Value7 => typeof(T7),
        Union13Index.Value8 => typeof(T8),
        Union13Index.Value9 => typeof(T9),
        Union13Index.Value10 => typeof(T10),
        Union13Index.Value11 => typeof(T11),
        Union13Index.Value12 => typeof(T12),
        Union13Index.Value13 => typeof(T13)
    };
    ...
    /// <para><c>(T1? val1, T2? val2, T3? val3, T4? val4, T5? val5, T6? val6, T7? val7, T8? val8, T9? val9, T10? val10, T11? val11, T12? val12, T13? val13) = myUnionType;</c></para>
    /// <para>Can also be called directly with <c>out</c> variables:</para>
    /// <para><c>myUnionType.Deconstruct(out T1? val1, out T2? val2, out T3? val3, out T4? val4, out T5? val5, out T6? val6, out T7? val7, out T8? val8, out T9? val9, out T10? val10, out T11? val11, out T12? val12, out T13? val13);</c></para>
    /// </summary>
    /// <param name="value1">Value of type <typeparamref name="T1"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value1"/>, otherwise <c>default</c>.</param>
    /// <param name="value2">Value of type <typeparamref name="T2"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value2"/>, otherwise <c>default</c>.</param>
    /// <param name="value3">Value of type <typeparamref name="T3"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value3"/>, otherwise <c>default</c>.</param>
    /// <param name="value4">Value of type <typeparamref name="T4"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value4"/>, otherwise <c>default</c>.</param>
    /// <param name="value5">Value of type <typeparamref name="T5"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value5"/>, otherwise <c>default</c>.</param>
    /// <param name="value6">Value of type <typeparamref name="T6"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value6"/>, otherwise <c>default</c>.</param>
    /// <param name="value7">Value of type <typeparamref name="T7"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value7"/>, otherwise <c>default</c>.</param>
    /// <param name="value8">Value of type <typeparamref name="T8"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value8"/>, otherwise <c>default</c>.</param>
    /// <param name="value9">Value of type <typeparamref name="T9"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value9"/>, otherwise <c>default</c>.</param>
    /// <param name="value10">Value of type <typeparamref name="T10"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value10"/>, otherwise <c>default</c>.</param>
    /// <param name="value11">Value of type <typeparamref name="T11"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value11"/>, otherwise <c>default</c>.</param>
    /// <param name="value12">Value of type <typeparamref name="T12"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value12"/>, otherwise <c>default</c>.</param>
    /// <param name="value13">Value of type <typeparamref name="T13"/> if <see cref="ValueIndex"/> is <see cref="Union13Index.Value13"/>, otherwise <c>default</c>.</param>
